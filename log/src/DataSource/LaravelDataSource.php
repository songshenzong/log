	...
	protected function getRoutes() {
		...
		foreach ($routes as $route) {
			$routesData[] = [
				...
				'before' => method_exists($route, 'beforeFilters') ? implode(', ',
				                                                             array_keys($route -> beforeFilters())) : '',
				'after'  => method_exists($route, 'afterFilters') ? implode(', ',
				                                                            array_keys($route -> afterFilters())) : ''
			];
		}
